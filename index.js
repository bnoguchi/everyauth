...
everyauth.modules = {};
everyauth.enabled = {};
var includeModules = [['everymodule', false], ['password', true], ['ldap', true], ['oauth', false], ['twitter', true], ['linkedin', true]
  , ['oauth2', false], ['facebook', true], ['github', true], ['instagram', true], ['foursquare', true], ['google', true]];
