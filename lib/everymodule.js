...
var everyModule = module.exports = {
          ...
          this[property] = function (setTo) {
            ...
            if (!arguments.length) {
              if ('undefined' === typeof this[k])
                throw new Error('You are trying to access the attribute/method configured by `' + property + '`, which you did not configure. Time to configure it.');
              return this[k];
            }
            this[k] = setTo;
            return this;
  ...
  , routeHandler: function (method, routeAlias) {
      var routeSteps = this._routes[method][routeAlias]
        , allSteps = this._steps
          // TODO Move orderedSteps to a getter?
        , orderedSteps = routeSteps.map( function (stepName) {
